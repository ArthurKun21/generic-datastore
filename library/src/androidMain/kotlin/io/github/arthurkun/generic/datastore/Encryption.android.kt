...
/**
 * Android implementation of DataEncryption using AES-GCM.
 *
 ...
 */
class AndroidAESEncryption(private val key: String) : DataEncryption {
...
/**
 * Creates Android-specific encryption implementation.
 */
actual fun createPlatformEncryption(key: String): DataEncryption {
    return if (key.isBlank()) {
        NoOpEncryption()
    } else {
        AndroidAESEncryption(key)
    }
}
