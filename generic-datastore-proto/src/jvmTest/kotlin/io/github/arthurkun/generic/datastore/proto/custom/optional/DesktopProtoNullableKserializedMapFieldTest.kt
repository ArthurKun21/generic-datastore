...
class DesktopProtoNullableKserializedMapFieldTest : AbstractProtoNullableKserializedMapFieldTest() {

    @TempDir
    lateinit var tempFolder: File

    private val helper = DesktopCustomFieldProtoTestHelper.standard("test_proto_nullable_kserialized_map_field")
