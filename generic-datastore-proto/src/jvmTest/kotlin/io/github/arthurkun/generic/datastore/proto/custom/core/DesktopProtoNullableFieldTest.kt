...
class DesktopProtoNullableFieldTest : AbstractProtoNullableFieldTest() {

    @TempDir
    lateinit var tempFolder: File

    private val helper = DesktopCustomFieldProtoTestHelper.standard("test_proto_nullable_field")
