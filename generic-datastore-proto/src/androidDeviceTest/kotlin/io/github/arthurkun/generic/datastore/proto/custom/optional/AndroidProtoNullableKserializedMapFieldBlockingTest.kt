...
class AndroidProtoNullableKserializedMapFieldBlockingTest : AbstractProtoNullableKserializedMapFieldBlockingTest() {

    private val helper = AndroidCustomFieldProtoTestHelper.blocking(
        "test_proto_nullable_kserialized_map_field_blocking",
    )
