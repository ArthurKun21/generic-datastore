...
private const val TEST_BYTES_DATASTORE_NAME = "test_bytes_datastore"

@RunWith(AndroidJUnit4::class)
class AndroidBytesTest : AbstractBytesTest() {

    private val helper = AndroidTestHelper.standard(TEST_BYTES_DATASTORE_NAME)
