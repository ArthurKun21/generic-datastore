...
class DesktopProtoNullableSerializedListFieldTest : AbstractProtoNullableSerializedListFieldTest() {

    @TempDir
    lateinit var tempFolder: File

    private val helper = DesktopCustomFieldProtoTestHelper.standard("test_proto_nullable_serialized_list_field")
