...
class DesktopProtoKserializedSetFieldBlockingTest : AbstractProtoKserializedSetFieldBlockingTest() {

    @TempDir
    lateinit var tempFolder: File

    private val helper = DesktopCustomFieldProtoTestHelper.blocking("test_proto_kserialized_set_field_blocking")
