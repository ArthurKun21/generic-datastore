...
class IosCustomFieldProtoTestHelper private constructor(
    ...
    companion object {
        fun standard(datastoreName: String): IosCustomFieldProtoTestHelper {
            return IosCustomFieldProtoTestHelper(datastoreName, useStandardDispatcher = true)
        }

        fun blocking(datastoreName: String): IosCustomFieldProtoTestHelper {
            return IosCustomFieldProtoTestHelper(datastoreName, useStandardDispatcher = false)
        }
    }
}
