...
private const val TEST_DATASTORE_NAME = "test_nullable_serialized_list_datastore"

@RunWith(AndroidJUnit4::class)
class AndroidNullableSerializedListTest : AbstractNullableSerializedListTest() {
