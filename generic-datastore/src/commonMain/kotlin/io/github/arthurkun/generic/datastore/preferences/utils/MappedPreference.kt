...
/**
 * Maps a [io.github.arthurkun.generic.datastore.core.Prefs] of type [T] to a [io.github.arthurkun.generic.datastore.core.Prefs] of type [R], inferring the default value by converting
 ...
 * @return A new [io.github.arthurkun.generic.datastore.core.Prefs] instance of type [R].
 * @throws Exception if `convert(this.defaultValue)` fails.
 */
public fun <T, R> DatastorePreferenceItem<T>.mapIO(
    convert: (T) -> R,
    reverse: (R) -> T,
): DatastorePreferenceItem<R> =
    MappedPrefs(
        prefs = this,
...
/**
 * Maps a [io.github.arthurkun.generic.datastore.core.Prefs] of type [T] to a [io.github.arthurkun.generic.datastore.core.Prefs] of type [R] using provided converter functions.
 *
 ...
 *   of the original [io.github.arthurkun.generic.datastore.core.Prefs] instance (of type [T]) is used.
 *
 * @param T The original type of the preference value in storage.
 * @param R The target type for the preference value in the application.
 ...
 * @return A new [io.github.arthurkun.generic.datastore.core.Prefs] instance of type [R] that applies the specified conversions
...
/**
 * Internal implementation of a mapped [io.github.arthurkun.generic.datastore.core.Prefs].
 *
 * @param T The original type of the preference.
 * @param R The target type after conversion.
 * @property prefs The original [io.github.arthurkun.generic.datastore.core.Prefs] instance.
